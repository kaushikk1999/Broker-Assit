...
- **Phases 0–6 are implemented, mocks-first** (142/142 tests, full E2E). The pilot runs **mocks-first**
...
python -m app.worker.runner --all --seed --once          # Phase 4 ingestion (--seed bootstraps schema on a fresh DB; offline fixtures)
