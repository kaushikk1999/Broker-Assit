...
| **5 — Embedding Pipeline** | 🔵 none to structure | **Next** — structure it ([PHASE_5_KICKOFF.md](PHASE_5_KICKOFF.md)); end-to-end needs Phase 4 output + Ollama/Qdrant creds |
| **6 — RAG System** | 🟠 Phase 5 + vendor keys | After embeddings land |
