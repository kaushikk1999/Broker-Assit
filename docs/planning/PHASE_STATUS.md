...
>
> **Last verified:** 2026-06-24 (mocks-first dev mode, 20/20 tests, full E2E — see
> [TESTING.md](../reference/TESTING.md)).
>
> **2026-06-24 update — phase numbering corrected to the roadmap.** This ledger now uses the
> authoritative roadmap numbering: **Phase 4 = Data Ingestion Layer · Phase 5 = Embedding Pipeline ·
> Phase 6 = RAG · Phase 7 = Multilingual.** Earlier copies labeled "Real vendor adapters" as *Phase 4*;
> that is a cross-cutting **wiring workstream** ([NEXT_PHASE_PLAN.md](NEXT_PHASE_PLAN.md) §C), not a
> roadmap phase. **Phase 4 is now analyzed & design-approved but NOT implemented** —
> see [PHASE_4_PLAN.md](PHASE_4_PLAN.md). Next up: structure Phase 5 — [PHASE_5_KICKOFF.md](PHASE_5_KICKOFF.md)
> (start from [HANDOFF_TO_PHASE_5.md](HANDOFF_TO_PHASE_5.md)).
...
| **Test status** | Backend 20/20 pytest · frontend builds all 8 pages · live E2E verified |
| **What's NOT live** | Real AI vendors, real market data, the ingestion/embedding worker, production launch |
| **Next buildable thing (no creds)** | **Phase 4 — Data Ingestion Layer** (design-approved, ready to implement) — see [PHASE_4_PLAN.md](PHASE_4_PLAN.md). Then structure **Phase 5** — [PHASE_5_KICKOFF.md](PHASE_5_KICKOFF.md). |
