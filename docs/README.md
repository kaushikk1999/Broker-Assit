...
| Doc | Purpose |
|---|---|
| [planning/HANDOFF_TO_PHASE_5.md](planning/HANDOFF_TO_PHASE_5.md) | **Start here** — single entry point: true current status + how to structure Phase 5 |
...
| [planning/PHASE_5_KICKOFF.md](planning/PHASE_5_KICKOFF.md) | **Phase 5 — Embedding Pipeline** — kickoff brief to structure the next phase |
...
| [planning/DECISIONS_AND_OPEN_ITEMS.md](planning/DECISIONS_AND_OPEN_ITEMS.md) | Settled decisions (incl. Phase-4 locked decisions) + open ADRs/inputs that gate production |
