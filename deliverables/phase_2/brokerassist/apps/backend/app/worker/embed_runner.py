...
Mocks-first by default (credential-free). Set BA_USE_MOCKS=false + BA_OLLAMA_CLOUD_* + BA_QDRANT_* to
embed with the real embeddinggemma model into a real Qdrant brokerage_kb collection."""
